...
export class Edge extends GraphicalElement {
  ...
  firstDegree() {
    ...
    const y = this.isParent
      ? this.vertex.getEdgeY()
      : this.vertex.getEdgeY(true);
  ...
  secondDegree() {
    ...
    const y = this.isParent ? this.point.getY(true) : this.point.getY();
  ...
  draw(ctx) {
    ...
    if (this.isParent) {
      ctx.bezierCurveTo(
        ...
        this.firstCoordinate.y + 60,
        this.secondCoordinate.x,
        this.secondCoordinate.y - 60,
        this.secondCoordinate.x,
